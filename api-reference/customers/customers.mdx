...
- **Customer Management**  
  Manage customer profiles by creating, updating, or deleting customer records. Award social campaign rewards from your backend when you verify social actions on your side. This API ensures that you have up-to-date information on your customers, allowing for smooth and efficient customer interactions.
