...
- **Customer Management**  
  Manage customer profiles by creating, updating, or deleting customer records. Opt customers in or out of the loyalty program with [Update Customer Activation](/api-reference/customers/management/update-customer-activation). Award social campaign rewards from your backend when you verify social actions on your side. This API ensures that you have up-to-date information on your customers, allowing for smooth and efficient customer interactions.
