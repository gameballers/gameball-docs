...
- **Retrieve order transaction history** for many orders at once
...
<Card title="Order Transactions" icon="receipt" href="/api-reference/batches/batch-creation/order-transactions">
  Bulk retrieval of payment, reward, and refund history for up to 1,000 orders.
</Card>
