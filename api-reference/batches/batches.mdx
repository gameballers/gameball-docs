...
### Batch Creation
Allows bulk processing of customer data, orders, order transactions, balance inquiries, adjustments, cashback rewards, redemptions, and events. This improves efficiency by handling multiple records in a single request.
...
- **[Order Transactions](/api-reference/batches/batch-creation/order-transactions)** - Bulk order transaction history retrieval
