...
<Cards>
  ...
  <Card title="Order Points Breakdown" icon="list-check">
    See exactly **how points were earned** on a placed order:
    - Which items were eligible
    - The rate and campaign multiplier applied
    - How the item points add up to the total
  </Card>
...
<Steps>
  ...
  <Step title="Explain the Points Earned">
    Use **Order Points Breakdown** to show the customer, item by item, how the order's points were calculated.
  </Step>
</Steps>
...
<Tabs>
  ...
  <Tab title="Order Rewards & History">
    ...
    [Order Points Breakdown →](/api-reference/order/order-points-breakdown)
