...
More details can be found in the [Webhooks](/api-reference/webhooks/overview) section.

## Errors

<Tip>
To help you troubleshoot any issues, refer to the [Errors](/api-reference/overview/status-error-codes) section to learn about common error codes and their descriptions.
</Tip>
