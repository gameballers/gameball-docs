...
Gameball's Web Messages Communication Campaigns feature enables businesses to deliver targeted and personalized messages to customers.

<CardGroup cols={3}>
  <Card title="Promote Daily Deals" icon="tag">
    Display timely offers and deals as customers browse to drive immediate purchases.
  </Card>
  <Card title="Showcase New Collections" icon="sparkles">
    Introduce customers to new arrivals and collections at the right moment in their journey.
  </Card>
  <Card title="Motivate Customers to Complete Challenges" icon="trophy">
    Encourage customers to take action and finish reward campaigns for greater engagement.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Add Icons or Images">
...
<CardGroup cols={3}>
  <Card title="Create & Configure an Email Campaign" icon="envelope" href="/product-documentation/communication-campaigns/create-and-configure-email-campaigns">
    Set up email campaigns to reach customers with personalized messages.
  </Card>
  <Card title="Create & Configure a Mobile Push Campaign" icon="mobile" href="/product-documentation/communication-campaigns/create-and-configure-mobile-push-campaigns">
    Set up push notification campaigns to engage customers on their devices.
  </Card>
