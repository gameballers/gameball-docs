...
<Frame caption="Individual RFM score breakdown with plain-language explanation">
  ![RFM score breakdown per customer](/images/product-docs/customer-segmentation/rfm-segments/rfm-score-breakdown.png)
</Frame>
