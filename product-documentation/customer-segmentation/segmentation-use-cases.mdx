...
<Steps>
  ...
  <Step title="Add Total Amount Spent Filter">
    ...
    <Frame>
      <img src="/images/product-docs/customer-segmentation/champions-segment-config.png" alt="Champions segment configuration" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Add Last Redemption Date Filter">
    ...
    <Frame>
      <img src="/images/product-docs/customer-segmentation/champions-segment-alternative.png" alt="Alternative champions segment" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Add Product Title Filter">
    ...
    <Frame>
      <img src="/images/product-docs/customer-segmentation/product-viewers-segment-config.png" alt="Product viewers segment configuration" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Add Last Redemption Date Filter">
    ...
    <Frame>
      <img src="/images/product-docs/customer-segmentation/slipping-away-segment-config.png" alt="Slipping away customers segment" />
    </Frame>
  </Step>
</Steps>
...
In industries like fashion, high return rates eat into margins and signal potential program abuse. You can segment customers by how many returns they've made using the `order_refunded` event.

### Create a New Segment

<Steps>
  <Step title="Select the order_refunded Event">
    Choose **Event** as the segmentation type. Select **order_refunded**.
  </Step>
  <Step title="Set the Event Count Condition">
    Set the operator to **Count greater than** and enter your threshold (e.g., **3**) to target customers with 3 or more refunds.
  </Step>
</Steps>
...
<Tip>
  **Use Other Gameball Features**
  ...
  - Exclude high-return customers from bonus point campaigns to reduce liability.
  - Create a dedicated segment for low-return, high-spend customers and reward them for their behavior.
</Tip>
