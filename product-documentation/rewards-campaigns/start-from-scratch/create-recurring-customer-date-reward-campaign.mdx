---
title: "How Do I Create a Recurring Customer Date Reward Campaign?"
description: "Learn how to create and configure a recurring customer date reward campaign from scratch."
---
...
Let's explore the step-by-step process of creating and configuring a **recurring customer date** reward campaign from scratch.
...
<Frame>
  ![Create recurring customer date campaign](/images/product-docs/rewards-campaigns/start-from-scratch/create-recurring-date-campaign.png)
</Frame>
...
<Frame>
  ![Audience selection](/images/product-docs/rewards-campaigns/start-from-scratch/recurring-date-audience.png)
</Frame>
...
<Frame>
  ![Recurring date trigger](/images/product-docs/rewards-campaigns/start-from-scratch/recurring-date-trigger.png)
</Frame>
...
<Frame>
  ![Repeatability settings](/images/product-docs/rewards-campaigns/start-from-scratch/recurring-date-repeatability.png)
</Frame>
...
<Frame>
  ![Campaign details](/images/product-docs/rewards-campaigns/start-from-scratch/recurring-date-details.png)
</Frame>
...
<Frame>
  ![Reward types](/images/product-docs/rewards-campaigns/start-from-scratch/recurring-date-reward-types.png)
</Frame>
...
<Frame>
  ![Goal configuration](/images/product-docs/rewards-campaigns/start-from-scratch/recurring-date-goal.gif)
</Frame>
