...
<Step title="Details">
  ...
  - Reward Name
  - Reward Information
  - \[Optional\] **Redirection Link** (Navigates the customers to a desired page on the website/mobile app). You can use any URL — social sharing templates such as Instagram or TikTok do not restrict or validate the destination URL.
