...
<AccordionGroup>
<Accordion title="Stamp Campaigns" icon="stamp">
...
<Accordion title="Milestone Campaigns" icon="flag-checkered">
...
<Accordion title="Mission Campaigns" icon="map">
...
<AccordionGroup>
<Accordion title="Can I run all three campaign types at once?" icon="circle-question">
  Yes, you can run multiple campaigns simultaneously, but make sure they don't overlap or confuse your customers.
</Accordion>

<Accordion title="Which campaign type drives the most engagement?" icon="chart-line">
...
<CardGroup cols={2}>
<Card title="How to Configure a Stamp Campaign" icon="stamp" href="/product-documentation/rewards-campaigns/templates/engagement-gamification/stamps">
  Set up a stamp campaign to reward customers for repeated consecutive actions.
</Card>

<Card title="How to Set Up a Milestone Campaign" icon="flag-checkered" href="/product-documentation/rewards-campaigns/templates/engagement-gamification/milestone">
  Configure milestone campaigns that reward customers when they hit cumulative targets.
</Card>

<Card title="How to Create a Mission Campaign" icon="map" href="/product-documentation/rewards-campaigns/templates/engagement-gamification/mission">
  Build multi-step mission campaigns that combine diverse customer actions into one journey.
</Card>
</CardGroup>
