---
title: "How Do I Use the Event Engine?"
...
<Accordion title="[String] Equals" icon="equals">
  ...
  **Entering multiple values**
  ...
  When using a string field such as SKU, you can enter multiple comma-separated values in the same field (e.g., `SKU01, SKU02, SKU03`). The rule is satisfied if the order contains **any one** of the listed values — they are evaluated with **OR logic**.

  <Note>
  The field accepts up to **100 characters** in total (not a count of values). For SKUs, this accommodates approximately 10 values on average.
  </Note>
</Accordion>
