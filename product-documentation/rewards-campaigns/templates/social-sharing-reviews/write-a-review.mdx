...
Use Shopify Flow templates to reward customers on Gameball based on actions from other apps — for example, leaving a review on Yotpo, Reviews.io, AG Product Reviews, or any other Shopify Flow-compatible review app.
...
<Step title="Set the Trigger">
  Choose the app you use for reviews as the trigger — this works with any Shopify Flow-compatible review app, such as Yotpo, Reviews.io, or AG Product Reviews.
</Step>
...
The Write a Review campaign template defaults to **Limited to 1 time overall** — meaning each customer can only earn the reward once. You can change this in the campaign setup under **Repeatability**, where you can allow unlimited earnings, set a higher overall cap, or define a time-based limit (e.g., once per month).
</Note>
