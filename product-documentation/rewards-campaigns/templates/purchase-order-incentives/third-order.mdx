...
<Step title="Select the Template">
  Select the **Third Order** Template.
</Step>
...
The campaign trigger fires when the customer places **3 orders** on your platform:
...
<Steps>
<Step title="Customer Places 3 Orders">
  A customer places **3 orders** after the campaign is activated.
</Step>
