...
<Step title="Select the Template">
  Select the **Second Order** Template.
</Step>
...
The campaign trigger fires when the customer places **two orders** on your platform:
...
<Steps>
<Step title="Customer Places 2 Orders">
  A customer places **2 orders** after the campaign is activated.
</Step>
