...
<Steps>
  ...
  <Step title="Select the Template">
    Choose the **Subscribe to newsletter** template tagged with Shopify Flow.
  </Step>
...
<Steps>
  ...
  <Step title="Choose Trigger">
    Choose the trigger "**Customer Subscribed to Email Marketing**" from Shopify Triggers (or use any other trigger from your marketing app).
  </Step>
...
<Steps>
  <Step title="Subscribe">
    Customer subscribes to Shopify email marketing (e.g., via Checkout or a Popup).
  </Step>
  <Step title="Flow Triggers">
    Shopify Flow triggers the workflow when they subscribe.
  </Step>
  <Step title="Receive Reward">
    Gameball rewards the customer with the reward set in the "Subscribe to newsletter" campaign.
  </Step>
