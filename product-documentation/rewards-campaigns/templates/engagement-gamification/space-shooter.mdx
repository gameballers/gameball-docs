...
## Creating a Space Shooter Campaign
...
<Step title="Select the Template">
  Select the **Space Shooter** template.
</Step>
...
<Steps>
<Step title="Shoot Rewards, Avoid Bombs">
  Customers start by trying to hit the gifts and rewards and intentionally miss the bombs.
</Step>

<Step title="Reach the Score Target">
  Customers win if they reach a certain score before time ends.
</Step>

<Step title="Game Ends">
  The game ends when time ends.
</Step>
...
<Tabs>
<Tab title="Banner">
  Configure the banner that appears in the widget to promote the Space Shooter campaign.
</Tab>
