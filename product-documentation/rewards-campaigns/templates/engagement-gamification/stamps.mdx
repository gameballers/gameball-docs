...
<Note>
Stamps is a progress-tracking campaign, not a game campaign. Rewards are triggered automatically once a customer completes the required number of actions — no interaction with the widget or Game UI is required to earn the reward.
</Note>
