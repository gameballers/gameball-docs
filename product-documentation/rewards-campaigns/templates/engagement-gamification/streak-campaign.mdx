...
<Step title="Add Daily Rewards and Badges">
  ...
  <Note>
  The 10-row limit refers to the maximum number of unique reward **tiers** (variations) you can configure — not a cap on how long the streak can run. Once the last tier is reached, its reward repeats every day as long as the customer maintains their streak. Streaks continue indefinitely.
  </Note>
