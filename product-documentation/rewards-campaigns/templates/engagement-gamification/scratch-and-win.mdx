...
<Steps>
  ...
  <Step title="Select the Template">
    Choose the **Scratch & Win** template.
  </Step>
...
<Steps>
  <Step title="Scratch Card">
    Customers tap the card and **scratch** to reveal their reward.
  </Step>
  <Step title="Win a Prize">
    Prizes can include discounts, bonus points, free products, and more.
  </Step>
