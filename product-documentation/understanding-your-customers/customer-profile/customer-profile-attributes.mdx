...
| **Date of Birth** | Customer birth date (editable through the dashboard). Not automatically synced from Shopify — customers must provide it themselves, typically through a birthday reward campaign. | |
