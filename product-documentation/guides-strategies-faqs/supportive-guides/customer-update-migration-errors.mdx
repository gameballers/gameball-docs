---
title: "Common Customer Update/Migration Errors"
...
<Warning>In the case of updating data of an existing customer, any value in the migration sheet overrides what exists in the system.
...
If the customer has 0 points on the sheet, the customer's balance will be 0 after migration. If the points cell is empty, the customer balance will be 300.</Warning>
