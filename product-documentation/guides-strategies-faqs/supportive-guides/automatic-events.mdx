...
<Note>
Please note that the above are the only events automatically triggered by Gameball. The `account_created` event is **not** automatically fired for Shopify stores. If you need to track account creation, you must send this event manually using the [Track Event API](/tutorials/experiences/tracking-events).
</Note>
...
For more information and implementation guidance, check out the official Gameball documentation: [Tracking Customer Events](/tutorials/experiences/tracking-events).
