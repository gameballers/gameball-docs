...
<Accordion title="Redeem Tab" icon="ticket">
  ...
  <Frame caption="Coupon with source label shown in the Redeem Tab">
    ![Coupon source visibility in widget](/images/product-docs/customer-widget/coupon-source-widget.png)
  </Frame>
</Accordion>
