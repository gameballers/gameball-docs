...
To create a reward campaign from scratch, follow the steps in this [article](/product-documentation/rewards-campaigns/start-from-scratch/create-action-based-reward-campaign).
