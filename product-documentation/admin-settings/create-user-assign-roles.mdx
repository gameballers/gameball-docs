...
Gameball supports two-factor authentication (2FA) for dashboard user accounts to add an extra layer of security at login.

<Note>
Disabling 2FA is not a self-service action. If you need to disable 2FA for a user account, contact Gameball Support at support@gameball.co — this is handled manually on the backend.
</Note>
