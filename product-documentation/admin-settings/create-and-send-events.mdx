...
Events are the actions performed by your customers on your platform. Your platform should fire signals to Gameball when important events occur. In other words, Gameball should be notified when customers perform certain actions or sequences of actions on your platform. [Learn more](/api-reference/events/send-events)
