...
<AccordionGroup>
  <Accordion title="Enrolled Members" icon="users">
  ...
  <Accordion title="Excluded Members" icon="user-slash">
  ...
  <Accordion title="Member Growth" icon="chart-line">
  ...
  <Accordion title="Tier Distribution" icon="layer-group">
...
<AccordionGroup>
  <Accordion title="Engagement Rate" icon="percent">
  ...
  <Accordion title="Engaged Customers" icon="user-check">
  ...
  <Accordion title="Interactions" icon="hand-pointer">
...
<AccordionGroup>
  <Accordion title="Retention Rate" icon="rotate">
  ...
  <Accordion title="Customers Who Placed Orders" icon="bag-shopping">
  ...
  <Accordion title="Retention Cohort" icon="table-cells">
