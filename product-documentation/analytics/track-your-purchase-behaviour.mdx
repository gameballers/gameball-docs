---
title: "How Do I Track Your Purchase Behaviour Using Gameball Analytics?"
...
<Steps>
  ...
  <Step title="Navigate to Purchase Behavior">
...
<AccordionGroup>
  <Accordion title="Attributed Sales" icon="bag-shopping">
  ...
  <Accordion title="Attributed Revenue" icon="circle-dollar-sign">
  ...
  <Accordion title="Revenue Attributed by Time" icon="chart-line">
  ...
  <Accordion title="Revenue Contribution" icon="chart-pie">
  ...
  <Accordion title="AOV (Average Order Value)" icon="receipt">
  ...
  <Accordion title="Order Frequency" icon="arrow-rotate-right">
  ...
  <Accordion title="ABS (Average Basket Size)" icon="basket-shopping">
  ...
  <Accordion title="LTV Segmentation" icon="users-between-lines">
  ...
  <Accordion title="AOV Segmentation" icon="chart-bar">
  ...
  <Accordion title="Order Frequency Segmentation" icon="chart-column">
  ...
  <Accordion title="ABS Segmentation" icon="table-cells-large">
  ...
  <Accordion title="Transaction Volume" icon="money-bill-transfer">
