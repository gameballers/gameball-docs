...
<CardGroup cols={2}>
  <Card title="Increase Average Order Value" icon="arrow-trend-up">
  ...
  <Card title="Reduce Cart Abandonment" icon="cart-shopping">
    Motivate customers to complete the purchase by showing the reward they will get by completing their purchase.
  </Card>
</CardGroup>
...
<Tabs>
  <Tab title="Guest Customers">
    If the customer isn't logged in, the block will show the potential points they can earn based on default "earn points" rules, ignoring any custom order reward per tier.
  ...
  <Tab title="Logged-In Customers">
    For logged-in customers, the block displays points based on any customized reward rules per collection, merchant, or level, giving a tailored view of rewards.
...
<AccordionGroup>
  <Accordion title="Can I display the Potential Points Block on other pages?" icon="circle-question">
