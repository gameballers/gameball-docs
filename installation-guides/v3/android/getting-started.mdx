---
title: "How Do I Get Started with the Android SDK (v3)?"
sidebarTitle: "Getting Started"
description: "Install Gameball Android SDK v3.2.1 and set up your project"
---

# Installation & Setup

This guide helps you set up your project and install the **Gameball Android SDK v3.2.1**.\
...
<AccordionGroup>
  <Accordion title="Dependency Not Found">
    **Symptoms:** Gradle cannot resolve `com.github.gameballers:gb-mobile-android:3.2.1`. **Solutions:**
