---
title: "How Do I Initialize the Customer Widget in the Web SDK (v3)?"
sidebarTitle: "Initialize Gameball Customer Widget"
description: "Get started on integrating the Gameball customer's profile into your website or web app"
---

The Gameball widget is a customized loyalty interface your customers see when they are on your platform. The widget is where they can learn more about the loyalty program, track their progress, find their referral URL, and find other loyalty profile information. Learn more about [Gameball widget](/product-documentation/customer-widget/introduction-to-customer-widget).
...
<div className="security-banner">
  ...
  <div className="security-banner-content">
    <strong>Secure API Access:</strong> To benefit from v4.1 secure API endpoints, pass the <code>sessionToken</code> parameter during SDK initialization (optional now, required in SDK v4). This enables automatic routing to v4.1 secure endpoints. <a href="/api-reference/introduction-v4.1">Learn more about v4.1 →</a>
  </div>
</div>
...
<script>
    window.GbLoadInit = function(){
        GbSdk.init({
            ...
            playerUniqueId: '',
            playerAttributes:{},
            sessionToken: '{{your_session_token}}', // Optional now, required in SDK v4
        });
    };
</script>
...
For non-logged-in customers, use the below snippet with just your Gameball APIKey. Please check the article [How can you get your account integration details? (API Key & Secret Key)](/product-documentation/admin-settings/get-api-keys) to learn more on how to get your unique APIKey.
...
Session token for secure authentication, enables automatic routing to v4.1 secure endpoints. Optional now, required in SDK v4.
...
<Info>
Learn how you can configure the languages on your Gameball account through [this article](/product-documentation/customer-widget/start-configuring-profile/configure-customer-widget-language-on-your-platform).
</Info>
...
- [Customer Management](/installation-guides/v3/web/customer-management) - Create and manage customer profiles
