---
title: "How Do I Migrate to the React Native SDK v3?"
...
- View [RELEASE_NOTES.md](https://github.com/gameballers/gameball-react-native/blob/release-3.1.2/RELEASE_NOTES.md) for v3.1.2 release details
