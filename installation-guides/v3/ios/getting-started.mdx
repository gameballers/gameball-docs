---
title: "How Do I Get Started with the iOS SDK (v3)?"
sidebarTitle: "Getting Started"
description: "Install and set up Gameball iOS SDK v3.2.2"
---

This guide helps you install the **Gameball iOS SDK v3.2.2** and prepare your project for integration.\
...
3. Select **Version 3.2.2** (or **Up to Next Major**)
4. Click **Add Package**
...
- Confirm you selected **3.2.2** (or newer) in the package dialog
