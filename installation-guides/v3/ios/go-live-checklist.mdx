---
title: "How Do I Complete the Go-Live Checklist for the iOS SDK (v3)?"
sidebarTitle: "Go-Live Checklist"
description: "Verify your Gameball iOS SDK integration before releasing to production"
---

Use this checklist to ensure your **Gameball iOS SDK v3.2.2** integration is functionally correct, secure, and ready for production launch.
...
- Gameball iOS SDK **v3.2.2** installed via Swift Package Manager
