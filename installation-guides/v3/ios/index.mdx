---
title: "iOS SDK Integration (v3)"
sidebarTitle: "Overview"
description: "Complete guide to integrate Gameball with your iOS application using SDK v3.2.2"
---

# Gameball iOS SDK - v3.2.2

This documentation is tailored to **Gameball iOS SDK v3.2.2**. Use these pages as a versioned SDK reference for teams embedding Gameball into their iOS applications.

<Info>
  SDK v3.2.x adds a widget event channel, programmatic widget dismissal, external-link handling, and channel-merging parameters. All v3.x functionality remains fully compatible.
</Info>
...
<CardGroup cols={2}>
  <Card title="Getting Started" icon="rocket" href="/installation-guides/v3/ios/getting-started">
    Install the Gameball iOS SDK v3.2.2 and set up your project
  </Card>
...
1. Retrieve a session token from your backend using the [Create/Update Customer API](/api-reference/customers/management/create-customer).
