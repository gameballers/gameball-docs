---
title: "How Do I Integrate Points Redemption with the Flutter SDK (v2, Legacy)?"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="credit-card"
    href="/tutorials/experiences/points-redemption/pay-with-points"
  >
  ...
  <Card
    ...
    icon="ticket"
    href="/tutorials/experiences/points-redemption/convert-points-to-coupons/index"
  >
