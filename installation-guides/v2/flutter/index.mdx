---
title: "Flutter SDK Integration (v2, Legacy)"
...
<Note>
This integration guide is based on the official [Gameball Flutter documentation](/installation-guides/v2/flutter/getting-started). All code examples and configurations are directly sourced from the official documentation.
</Note>
