---
title: "How Do I Track Referrals with the iOS SDK (v2, Legacy)?"
...
**Configure Firebase information on your [Gameball's account dashboard](/product-documentation/admin-settings/configure-firebase-push-notifications).**
