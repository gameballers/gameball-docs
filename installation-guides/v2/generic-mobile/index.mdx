---
title: "How Do I Get Started with Generic Mobile App Integration?"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="user"
    href="/installation-guides/v2/generic-mobile/initialize-profile"
  >
  ...
  <Card
    ...
    icon="phone"
    href="/installation-guides/v2/generic-mobile/track-events"
  >
  ...
  <Card
    ...
    icon="dollar-sign"
    href="/installation-guides/v2/generic-mobile/track-orders"
  >
  ...
  <Card
    ...
    icon="credit-card"
    href="/installation-guides/v2/generic-mobile/integrate-redemption"
  >
  ...
  <Card
    ...
    icon="users"
    href="/installation-guides/v2/generic-mobile/track-referrals"
  >
  ...
  <Card
    ...
    icon="bell"
    href="/installation-guides/v2/generic-mobile/push-notifications"
  >
