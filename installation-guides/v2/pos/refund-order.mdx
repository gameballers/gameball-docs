---
title: "How Do I Refund an Order with Gameball POS (v2, Legacy)?"
sidebarTitle: "Refund Order"
...
- **transactionTime**: The timestamp when the refund occurred, in UTC (ISO 8601 format)
