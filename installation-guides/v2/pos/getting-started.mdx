---
title: "How Do I Get Started with Gameball POS (v2, Legacy)?"
...
1. [API Setup](/installation-guides/v2/pos/api-setup) - Configure API authentication and credentials
2. [Customer Management](/installation-guides/v2/pos/customer-management) - Learn how to register customers at checkout
