...
Gameball uses Firebase and Huawei services to deliver maximum experience in your app. This includes push notifications, interactive in-app messaging. This depends on the initialization method mentioned earlier [here](/installation-guide/android/getting-started#initialize-push-notifications), retrieving either Firebase or Huawei device tokens.
