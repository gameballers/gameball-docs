...
1. [API Setup](/installation-guide/pos-v3/api-setup) - Configure API authentication and credentials
2. [Customer Management](/installation-guide/pos-v3/customer-management) - Learn how to register customers at checkout
