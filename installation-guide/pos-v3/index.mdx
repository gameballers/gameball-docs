...
<CardGroup cols={2}>
  ...
  <Card title="Refund Order" icon="arrow-rotate-left" href="/installation-guide/pos-v3/refund-order">
    Refund or cancel orders and restore customer points
  </Card>

  <Card title="Fetch Order Details" icon="receipt" href="/installation-guide/pos-v3/fetch-order-details">
