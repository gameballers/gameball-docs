...
1. [Initialize Widget](/installation-guide/web/initialize-widget) - Set up the Gameball widget on your website
2. [Customer Management](/installation-guide/web/customer-management) - Learn how to create and manage customer profiles
