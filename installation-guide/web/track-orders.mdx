...
<Note>
For detailed implementation examples, refer to the [Checkout Integration tutorial](/tutorials/checkout-integration) and [Previewing Potential Points Before Purchase](/tutorials/previewing-potential-points-before-purchase).
</Note>
