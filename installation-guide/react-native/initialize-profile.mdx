...
The referral code of an existing customer who is referring the customer being created. This is required in the create customer request to process the referral. Check [Track Referrals](/installation-guide/react-native/track-referrals) for more details
</ParamField>
