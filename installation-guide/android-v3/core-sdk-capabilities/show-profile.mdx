...
<Info>
  Before showing the profile widget, make sure the SDK is initialized and the customer has been registered using [Initialize SDK](https://gameball.mintlify.app/installation-guide/android-v3/getting-started#initialize-the-sdk) and [Initialize Customer Profile](https://gameball.mintlify.app/installation-guide/android-v3/initialize-profile).
</Info>
...
<Tip>
**Secure API Access:** To benefit from secure API endpoints, pass the `sessionToken` parameter when showing the profile widget. This enables automatic routing to v4.1 secure endpoints.
</Tip>
