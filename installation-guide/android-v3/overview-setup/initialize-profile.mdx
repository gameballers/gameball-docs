...
<Info>
  Before calling `initializeCustomer,`make sure you have already initialized the SDK using [ Initialize SDK](https://gameball.mintlify.app/installation-guide/android-v3/getting-started#initialize-the-sdk)
</Info>
...
);https://gameball.mintlify.app/installation-guide/android-v3/getting-started#initialize-the-sdk
```
