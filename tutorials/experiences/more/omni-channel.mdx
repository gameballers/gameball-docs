...
<Step title="Contact Gameball Support">
  ...
  <Warning>
  Before Channel Merge is enabled, Gameball runs an automatic duplicate-detection check and emails you the results. Channel Merge stays blocked while duplicates exist — resolve any duplicate profiles first, then re-attempt. A fresh check runs each time you retry.
  </Warning>
</Step>
