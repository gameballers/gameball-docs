...
| The Catcher (First)        | `catcher`                      | ✅             | ✅             |
| Specific Catcher           | `catcher_{CampaignID}`         | ❌             | ✅             |
| Quiz (First)               | `quiz`                         | ✅             | ✅             |
| Specific Quiz              | `quiz_{CampaignID}`            | ❌             | ✅             |
| Space Shooter (First)      | `shooter`                      | ✅             | ✅             |
| Specific Space Shooter     | `shooter_{CampaignID}`         | ❌             | ✅             |
| Tap the Target (First)     | `tap_target`                   | ✅             | ✅             |
| Specific Tap the Target    | `tap_target_{CampaignID}`      | ❌             | ✅             |
| Driving Game (First)       | `highway_drive`                | ✅             | ✅             |
| Specific Driving Game      | `highway_drive_{CampaignID}`   | ❌             | ✅             |
| Sliding Puzzle (First)     | `puzzle`                       | ✅             | ✅             |
| Specific Sliding Puzzle    | `puzzle_{CampaignID}`          | ❌             | ✅             |
| Tic Tac Toe (First)        | `tictactoe`                    | ✅             | ✅             |
| Specific Tic Tac Toe       | `tictactoe_{CampaignID}`       | ❌             | ✅             |
| Survey (First)             | `survey`                       | ✅             | ✅             |
| Surveys List               | `survey_list`                  | ❌             | ✅             |
| Specific Survey            | `survey_{CampaignID}`          | ❌             | ✅             |
| Mission (First)            | `mission`                      | ✅             | ✅             |
| Specific Mission           | `mission_{CampaignID}`         | ❌             | ✅             |
| Streak (First)             | `streak`                       | ✅             | ✅             |
| Specific Streak            | `streak_{CampaignID}`          | ❌             | ✅             |
| Games                      | `games`                        | ✅             | ✅             |

<Note>
When you pass a section key through an SDK, prefix it with `details_`. For example, `catcher` becomes `details_catcher`, and a specific campaign becomes `details_catcher_123`.
</Note>
...
https://your-site.com/#gameball-quiz
https://your-site.com/#gameball-catcher
...
https://your-site.com/?gameball-deep=quiz
https://your-site.com/?gameball-deep=catcher
...
gameballApp.showProfile(this, "customer_id", "details_quiz", true)
gameballApp.showProfile(this, "customer_id", "details_catcher_123", true)
```
