...
<Warning>
**Prerequisites**: Before implementing push notifications, you must configure your Firebase account in your Gameball dashboard. Follow the steps in the [Firebase push notifications guide](/product-documentation/admin-settings/configure-firebase-push-notifications).
</Warning>
