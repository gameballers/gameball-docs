...
<Note>
**Gameball-managed WhatsApp vs. your own WhatsApp provider**

Gameball offers a built-in WhatsApp notification channel through its exclusive provider (Tanla). If your account is configured to use Tanla, WhatsApp notifications are sent automatically with no extra setup.

If you want to use your **own** WhatsApp provider (e.g., Unifonic, Twilio, or any other Business API), use the webhook approach described in this article — Gameball sends a notification event to your endpoint, and your system routes it to WhatsApp through your provider. Gameball does not send messages through third-party WhatsApp providers directly.

**SMS** works with any provider — there is no restriction on which SMS gateway you use.
</Note>
...
<Frame>
<img src="https://1167798217-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M3kSf4Ga0rOah5Au2jA%2F-MiYnJlNfBAsXuCHert0%2F-MiYt03v8B2sZMvrMHuR%2Fin-App%20notifications%20Mobile.png?alt=media&token=e93deb02-b628-4591-a00e-ead07509be92" alt="Example mobile notification" />
</Frame>
...
<Frame>
<img src="https://1167798217-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M3kSf4Ga0rOah5Au2jA%2F-MiYt8MQhXulcPWGYzZA%2F-MiYtNmuWSLHxNTvjKnB%2Fin-App%20notifications%20Mobile%20(1).png?alt=media&token=ca835e98-806d-418d-9fdb-71ede9b779ac" alt="Push Notification" />
</Frame>
...
- [Customer Notifications](/tutorials/experiences/more/build-your-own-ui/notifications)
- [Redemption Integration](/tutorials/experiences/points-redemption/index)
