...
<Info>
  After previewing points, you'll need to track the actual order. See [Submitting Orders](/tutorials/experiences/order-handling/submit-order) to learn how to integrate order submission with Gameball.
</Info>
...
<CardGroup cols={2}>
  <Card title="Submit Orders" icon="shopping-cart" href="/tutorials/experiences/order-handling/submit-order">
    Learn how to track completed orders and trigger rewards
  </Card>
  <Card title="Points Redemption" icon="gift" href="/tutorials/experiences/points-redemption/index">
