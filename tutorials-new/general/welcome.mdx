---
title: 'Welcome to Gameball Tutorials'
...
<Step title="Start with the basics">
  If you're new to Gameball, begin with the **General** section to understand core entities and concepts.
</Step>

<Step title="Choose your journey">
  Jump to the **Experiences** section that matches your immediate integration need—whether it's order submission, redemption, or event tracking.
</Step>

<Step title="Follow the customer story">
  Each tutorial walks through a customer's journey step-by-step. Read through the narrative to understand the complete flow.
</Step>

<Step title="Examine the API calls">
  Study the request-response examples. These are real API interactions you'll implement in your code.
</Step>

<Step title="Adapt to your needs">
  Use the examples as templates, customizing them for your specific business logic and customer experience.
</Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Installation Guides" icon="download" href="/installation-guide">
