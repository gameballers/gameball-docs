---
title: "What Are Previewing Potential Points?"
...
<Info>
  After previewing points, you'll need to track the actual order. See [Submitting Orders](/tutorials-new/experiences/order-handling/submit-order) to learn how to integrate order submission with Gameball.
</Info>
...
<img
  src="/images/productwithPointsPreviewed.png"
  className="mx-auto"
  style={{ width:"41%" }}
/>
...
<img
  src="/images/triplePointsCampaign.png"
  className="mx-auto"
  style={{ width:"80%" }}
/>
***
...
<img
  src="/images/HoldayBonusBanner-1.png"
  className="mx-auto"
  style={{ width:"80%" }}
/>
...
<CardGroup cols={2}>
  <Card title="Submit Orders" icon="shopping-cart" href="/tutorials-new/experiences/order-handling/submit-order">
    Learn how to track completed orders and trigger rewards
  </Card>
  <Card title="Points Redemption" icon="gift" href="/tutorials-new/experiences/points-redemption/index">
    Enable customers to redeem their earned points for rewards
  </Card>
</CardGroup>
