...
**Scenario:** A specific item has a discount applied directly (e.g. item on sale). Tax is calculated on the discounted amount.
...
| 2 | Line Item Discount | $567.50 | $50 | $517.50 | $517.50 |
