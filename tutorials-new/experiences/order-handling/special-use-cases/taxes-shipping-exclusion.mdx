...
![Image(131) Pn](/images/image\(131\).png)
...
That’s why, if you choose to exclude tax and shipping, it’s critical to send **complete and accurate values** in the [**Order API**](https://gameball.mintlify.app/api-reference/order/order-tracking), so Gameball can apply deductions correctly.
