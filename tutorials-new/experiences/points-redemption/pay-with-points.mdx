...
This [API](https://gameball.mintlify.app/api-reference/customers/progress/get-customer-balance) returns a full breakdown of the customer’s loyalty points, including available, total, and pending balances.
...
- Call the [**Hold Points API**](https://gameball.mintlify.app/api-reference/transactions/hold-management/hold)
...
- Call the [**Order API**](https://gameball.mintlify.app/api-reference/order/order-tracking)
...
**Gameball touchpoint:** When the user presses **“Place Order”**, the [**Track Order API **](https://gameball.mintlify.app/api-reference/order/order-tracking)should be triggered.
...
#### **Manual Release (**[**Release Hold API**](https://gameball.mintlify.app/api-reference/transactions/hold-management/release)**)**
...
To do this, call the [**Release Hold API**](https://gameball.mintlify.app/api-reference/transactions/hold-management/release) using the original holdReference.
