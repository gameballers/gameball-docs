---
title: "What Are Pay with Points?"
...
This [API](/api-reference/customers/progress/get-customer-balance) returns a full breakdown of the customer’s loyalty points, including available, total, and pending balances.
...
- **totalPointsValue**: The total monetary value of the customer's points, including pending points.
...
- Call the [**Hold Points API**](/api-reference/transactions/hold-management/hold)
- This **temporarily holds** those points on Gameball’s side, ensuring they can’t be used twice (e.g., on another device or browser)
...
- Call the [**Order API**](/api-reference/order/order-tracking)
...
**Gameball touchpoint:** When the user presses **“Place Order”**, the [**Track Order API**](/api-reference/order/order-tracking) should be triggered.
...
#### **Manual Release (**[**Release Hold API**](/api-reference/transactions/hold-management/release)**)**
...
To do this, call the [**Release Hold API**](/api-reference/transactions/hold-management/release) using the original holdReference.
...
<Checklist>
  <Check>The customer navigates to another product.</Check>
  <Check>They modify the cart and want to reapply a different point amount.</Check>
  <Check>You need to release the points based on business logic (e.g., canceled order).</Check>
</Checklist>
...
<CardGroup cols={2}>
  <Card title="Get Customer Balance API" icon="scale-balanced" href="/api-reference/customers/progress/get-customer-balance">
    Retrieve available, total, and pending points
  </Card>
  <Card title="Hold Points API" icon="hand" href="/api-reference/transactions/hold-management/hold">
    Reserve points during checkout before payment
  </Card>
  <Card title="Order API" icon="receipt" href="/api-reference/order/order-tracking">
    Submit orders and finalize point redemption
  </Card>
  <Card title="Release Hold API" icon="arrow-rotate-left" href="/api-reference/transactions/hold-management/release">
    Return held points when checkout is canceled
  </Card>
</CardGroup>
