...
- **Gameball’s Built-in Couponing Engine:** Use [POST /generate-coupon ](https://gameball.mintlify.app/api-reference/coupons/generate-coupon)_to issue a discount code based on a configured rule._
...
<Card title="Integrate Your Own Couponing Engine" icon="sparkles" href="https://gameball.mintlify.app/tutorials-new/experiences/points-redemption/convert-points-to-coupons/your-engine" cta="Learn how to issue rewards and coupons through your internal engine in this tutorial.">
...
<Card title="Enable Gameball's Native Discount Engine" icon="sparkles" href="https://gameball.mintlify.app/tutorials-new/experiences/points-redemption/convert-points-to-coupons/gameball-engine" cta="Learn how to issue rewards and discounts through Gameball’s built-in discount engine in this tutorial.">
