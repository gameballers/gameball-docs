  ...
  "steps": [
    {
      ...
      "friendReward": {
        "coupon": { "type": "Percentage", "value": 10, "expiryDate": "2025-12-31T23:59:59Z" }
      }
    },
    {
      ...
      "friendReward": {
        "coupon": { "type": "FixedAmount", "value": 20, "expiryDate": "2025-12-31T23:59:59Z" }
      }
    }
  ]
}
...
- On friend signup, call [**Create/Update Customer**](https://gameball.mintlify.app/api-reference/customers/management/create-customer) and include `referrerCode`: "code123" **during initial registration** (within your program’s allowed window).
