...
<Tab title="iOS">
  ...
  <Tip>
  See the [iOS Push Notifications installation guide](/installation-guide/ios/push-notifications) for complete implementation details.
  </Tip>
</Tab>
...
<Tab title="Android">
  ...
  <Tip>
  See the [Android Push Notifications installation guide](/installation-guide/android/push-notifications) for platform-specific implementation details.
  </Tip>
</Tab>
...
<Tab title="React Native">
  ...
  <Tip>
  See the [React Native Push Notifications installation guide](/installation-guide/react-native/push-notifications) for framework-specific implementation.
  </Tip>
</Tab>
</Tabs>
...
<Tip>
For more information on webhook verification, see the [Webhooks documentation](/api-reference/webhooks/subscribing-to-webhooks).
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="iOS Push Notifications" icon="mobile" href="/installation-guide/ios/push-notifications">
